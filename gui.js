  ...
  var updateFxTrack = function (selectionOnly) {
    ...
    for (var i = 0; i < 32; ++i) {
      ...
      if (!selectionOnly) {
        var fxTxt = ":";
        if (pat >= 0) {
          var fxCmd = mSong.songData[mSeqCol].c[pat].fx[i];
          if (fxCmd) {
            var fxVal = mSong.songData[mSeqCol].c[pat].fx[i+32];
    ...
    if (mSeqCol == mSeqCol2)
    {
      ...
      if (mEditMode == EDIT_FXTRACK && mSeqRow == mSeqRow2 && fxCmd) {
        ...
        if (pat >= 0) {
          ...
          mSong.songData[mSeqCol].c[pat].fx[mFxTrackRow+32] = fxValue;
          updateFxTrack();
        }
      }
    ...
    if (mSeqCol == mSeqCol2) {
      ...
      if (mEditMode == EDIT_FXTRACK && mSeqRow == mSeqRow2) {
        ...
        if (pat >= 0) {
          ...
          mSong.songData[mSeqCol].c[pat].fx[mFxTrackRow+32] = wave;
          updateFxTrack();
        }
      }
    ...
    if (mSeqCol == mSeqCol2)
    {
      ...
      if (mEditMode == EDIT_FXTRACK && mSeqRow == mSeqRow2) {
        ...
        if (pat >= 0) {
          ...
          mSong.songData[mSeqCol].c[pat].fx[mFxTrackRow+32] = filt;
          updateFxTrack();
        }
      }
      ...
      if (mEditMode == EDIT_FXTRACK) {
        ...
        if (mSeqRow == mSeqRow2 && mSeqCol == mSeqCol2)
        {
          ...
          if (pat >= 0) {
            ...
            mSong.songData[mSeqCol].c[pat].fx[mFxTrackRow+32] = x;
            updateFxTrack();
          }
        }
      }
